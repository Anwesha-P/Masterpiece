...
import swaggerJSDoc from "swagger-jsdoc"; // Fixed import
import swaggerUi from "swagger-ui-express"; // Fixed import
...
const specs = swaggerJSDoc(options); // Fixed - need to pass options
 ...
 */
app.get("/thresholds/:sku", (req: Request, res: Response) => {
 ...
 *         description: Database error
 */
app.get("/audit/:storeid", (req: Request, res: Response) => {
